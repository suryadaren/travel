        ...
        <div class="col-12">
          ...
          <div class="card">
            <div class="card-header">
              <h3 class="card-title">Daftar Kota Tujuan</h3>
            </div>
            <!-- /.card-header -->
            <div class="card-body">
              <a href="/operators/tambah_kota_tujuan" class="btn btn-primary">Tambah Kota</a>
              <br><br>
              <table id="example1" class="table table-bordered table-striped">
                ...
                <tbody>
                	...
                	<tr>
                		...
                		<td>sby</td>
                		<td>
                      <a href="/operators/edit_kota_tujuan/1" class="btn btn-warning">Edit</a>
